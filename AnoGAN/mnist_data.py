...
"""
## 读取训练集数据  （60000，785）
train = pd.read_csv("E:\deep-learning\AnoGAN\data\mnist_train.csv",dtype = np.float32)
## 读取测试集数据  （10000，785）
test = pd.read_csv("E:\deep-learning\AnoGAN\data\mnist_test.csv",dtype = np.float32)
